...
class WTTArmoryM76 {
    ...
    displayCreditBanner() {
        ...
        this.Instance.logger.log(`[${this.modName}] WTT-Armory-M76`, LogTextColor_1.LogTextColor.GREEN);
        this.Instance.logger.log(`[${this.modName}] Developers: Tron`, LogTextColor_1.LogTextColor.GREEN);
        this.Instance.logger.log(`[${this.modName}] Slightly longer AK go boom`, LogTextColor_1.LogTextColor.GREEN);
        this.Instance.logger.log(`[${this.modName}] ------------------------------------------------------------------------`, LogTextColor_1.LogTextColor.GREEN);
    }
}
module.exports = { mod: new WTTArmoryM76() };
